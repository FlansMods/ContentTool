...
public class GunTypeImporter : TxtImporter<GunType>
{
	...
	public override void read(GunType obj, string[] split, TypeFile file)
	{
		...
		//Modes and zoom settings
			...
			obj.mode = EnumExtensions.Parse(split[1]);
...
public class DriveableTypeImporter : TxtImporter<DriveableType>
{
	...
	// BASICS /////////////////////////////////////////////////////////////////////////////
		...
		parsers.Add("ModePrimary", (split, d) => d.modePrimary = EnumExtensions.Parse(split[1].ToUpper()));
		parsers.Add("ModeSecondary", (split, d) => d.modeSecondary = EnumExtensions.Parse(split[1].ToUpper()));
...
//                model = FlansMod.proxy.loadModel(split[1], shortName, ModelAttachment.class);
		...
		//Mode override
			...
			obj.modeOverride = EnumExtensions.Parse(split[1]);
