...
public static class DefinitionTypes
{
	...
	public static ENewDefinitionType GetFromObject(Definition def)
	{
		...
		if(def is ControlSchemeDefinition) return ENewDefinitionType.controlScheme;
	...
	public static string Folder(this EDefinitionType defType)
	{
		switch(defType)
		{
			...
			case EDefinitionType.armour: return "armorFiles";
			case EDefinitionType.armourBox: return "armorBoxes";
	...
	public static string OutputFolder(this ENewDefinitionType defType)
	{
		switch(defType)
		{
			...
			case ENewDefinitionType.controlScheme: return "control_schemes";
			default:
			{
