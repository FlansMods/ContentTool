...
public static class FlanStyles
{
	...
	public static void LargeButtonArray(GUIContent[] icons, string[] names, ActionFunc[] actions, int maxSize = 100)
	{
		...
		for (int i = 0; i < icons.Length; i++)
		{
			...
			if (GUILayout.Button(icons[i], GUILayout.MaxHeight(maxSize), GUILayout.MaxWidth(maxSize)))
			{
				actions[i].Invoke();
			}
			GUILayout.FlexibleSpace();
	...
	public static readonly GUIContent GoToFolder = Button("FolderOpened Icon", "Show in Explorer");
	public static readonly GUIContent GoToModelFolder = Button("GameObject Icon", "Show in Explorer");
	public static readonly GUIContent OpenDocumentation = Button("SearchJump Icon", "Open Documentation");
